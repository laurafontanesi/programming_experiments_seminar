...
**Exercise 4a:** Implement a `choice_block` made of 20 trials, and let the participants repeat it until they reach 60\% accuracy.

**Exercise 4b (bonus):** Set the limit of practice block repetitions to 2, and otherwise let the experiment stop, preferably with a final message that tells the participant that the experiment has ended because they did not reach the minimum accuracy required. 
